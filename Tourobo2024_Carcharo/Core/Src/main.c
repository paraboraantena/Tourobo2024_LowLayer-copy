...
/**9/5に堺陽大が作ったプログラムです。
 * リングアームがなくなったため、ArmUatorに送信する内容を変えています。
 ******************************************************************************
 * @file           : main.c
...
//		rxbuf[6]=0b0000000000000001;
//		rxbuf[7]=0b0000000000000010;

		data_to_LedUator[0] = (uint8_t)rxbuf[6];//for pantaSole
		data_to_LedUator[1] = (uint8_t)rxbuf[7];//for Led


		data_to_ArmUator[0] = (uint8_t)rxbuf[4] << 3 | (uint8_t)rxbuf[5];//for nae ring Arm
